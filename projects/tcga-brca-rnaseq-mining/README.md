...
## Part 1 — Preprocessing & Exploration (`01_data_mining_preprocessing.Rmd`)
...
## Part 2 — Clustering & Classification (`02_clustering_classification.Rmd`)
Continues from Part 1 using the 10-PC feature matrix.
